...
import 'package:online_patient/app/screens/doctor/booking_screen.dart';
        ...
        body: FutureBuilder(
          ...
          builder: (context, snapshot) {
            if (snapshot.hasError) {
              ...
              log(snapshot.data!.docs.last.data().toString());
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(children: [
          Container(
            child: CircleAvatar(
              backgroundImage: AssetImage(' assets/555.jpg'),
              radius: 50,
            ),
          ),
          SizedBox(
