...
import 'package:online_patient/app/models/appointment_model.dart';
...
class BookingScreen extends StatefulWidget {
  ...
  @override
  _BookingScreenDentistState createState() => _BookingScreenDentistState();
}

class _BookingScreenDentistState extends State<BookingScreen> {
  ...
  void initState() {
    ...
    _SpecailController.text = widget.doctor.Special;
  }
        ...
        child: NotificationListener<OverscrollIndicatorNotification>(
          ...
          child: ListView(
            ...
            children: [
              Container(
                child: Image(
                  image: AssetImage(widget.doctor.imageUrl != null ||
