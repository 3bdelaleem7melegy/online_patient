...
import 'package:online_patient/app/models/analysis.dart';
...
class bookingscreenCholestrol extends StatefulWidget {
  final String type;
  final String name;
  final String id;

  const bookingscreenCholestrol(
      {required this.type, required this.name, required this.id});
  @override
  _bookState createState() => _bookState();
}

class _bookState extends State<bookingscreenCholestrol> {
  ...
  void initState() {
    ...
    _getUser();
    selectTime(context);
    _doctorController.text = widget.type;
