...
class myAppointmentsArchiveList extends StatefulWidget {
  const myAppointmentsArchiveList({super.key});

  @override
  _MyAppointmentListState createState() => _MyAppointmentListState();
}

class _MyAppointmentListState extends State<myAppointmentsArchiveList> {
